      ...
      <div className="max-w-3xl mx-auto">
        {!audioUrl ? <>
                ...
                <div className="flex flex-col gap-4 mb-8 p-6 bg-background rounded-lg border border-border text-left">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" value={startTime} onChange={e => setStartTime(e.target.value)} className="input w-full font-mono" placeholder="00:00:00" disabled={isProcessing} />
                    </div>
                    <div>
                      <label className="label">Duration (HH:MM:SS)</label>
                      <input type="text" value={duration} onChange={e => setDuration(e.target.value)} className="input w-full font-mono" placeholder="00:00:30" disabled={isProcessing} />
                    </div>
                  </div>
            ...
            setAudioUrl(null);
              ...
              <a href={audioUrl} download={`cut_${file?.name}`} className="btn btn-primary" style={{
            textDecoration: 'none'
          }}>
