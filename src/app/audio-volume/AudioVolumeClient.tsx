      ...
      <div className="max-w-3xl mx-auto">
        {!audioUrl ? <>
            ...
            {file && <div className="glass-card text-center">
                ...
                <div className="flex flex-col gap-4 mb-8 p-6 bg-background rounded-lg border border-border text-left">
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <input type="range" min="0.1" max="3.0" step="0.1" value={volume} onChange={e => setVolume(parseFloat(e.target.value))} className="w-full max-w-md" disabled={isProcessing} />
            ...
            setAudioUrl(null);
              ...
              <a href={audioUrl} download={`volume_${file?.name}`} className="btn btn-primary" style={{
            textDecoration: 'none'
          }}>
