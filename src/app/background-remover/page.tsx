...
export default function BackgroundRemoverPage() {
  const faq = [{
    ...
    answer: "No! Filoza uses an advanced WebAssembly AI model that runs entirely inside your browser. Your images never leave your device."
  }, {
    question: "Why does it take time to load initially?",
    answer: "The AI model (~40MB) needs to be downloaded to your browser the very first time you use the tool. Subsequent uses will be much faster!"
  }];
