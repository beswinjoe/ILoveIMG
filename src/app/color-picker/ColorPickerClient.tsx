  ...
  return <>
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          {!imageSrc ? <div className="dropzone h-full min-h-[400px] flex flex-col justify-center border-dashed" onDrop={handleDrop} onDragOver={e => e.preventDefault()} onClick={() => fileInputRef.current?.click()}>
            ...
            </div> : <div className="glass-card flex flex-col items-center">
              ...
              <div className="relative border border-border rounded overflow-hidden cursor-crosshair bg-[url('/checkers.png')]">
                <canvas ref={canvasRef} onMouseMove={handleCanvasMouseMove} onClick={handleCanvasClick} onMouseLeave={handleCanvasMouseLeave} className="max-w-full" />
                {hoverColor && <div className="absolute top-4 left-4 p-2 bg-background/90 backdrop-blur border border-border rounded shadow-lg flex items-center gap-3 pointer-events-none">
        ...
        <div className="md:w-80 flex flex-col gap-6">
          <div className="glass-card">
            ...
            <div className="w-full h-32 rounded-lg border border-border mb-6 shadow-inner transition-colors duration-200" style={{
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input type="color" value={selectedColor} onChange={e => setSelectedColor(e.target.value)} className="h-10 w-12 cursor-pointer rounded border border-border bg-background p-1" />
                  <input type="text" value={selectedColor.toUpperCase()} onChange={e => setSelectedColor(e.target.value)} className="input w-full uppercase font-mono" />
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-border space-y-3">
                <div className="flex justify-between items-center group">
                  ...
                  <button onClick={() => copyToClipboard(selectedColor.toUpperCase())} className="p-2 text-muted hover:text-foreground hover:bg-surface rounded opacity-0 group-hover:opacity-100 transition-all">
                ...
                <div className="flex justify-between items-center group">
                  ...
                  <button onClick={() => copyToClipboard(`rgb(${hexToRgb(selectedColor)})`)} className="p-2 text-muted hover:text-foreground hover:bg-surface rounded opacity-0 group-hover:opacity-100 transition-all">
