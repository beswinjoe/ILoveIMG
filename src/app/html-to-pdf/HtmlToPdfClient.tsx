      ...
      <div className="max-w-3xl mx-auto">
        {!outputUrl ? <>
            <div className="dropzone mb-8" onDrop={handleDrop} onDragOver={e => e.preventDefault()} onClick={() => fileInputRef.current?.click()}>
              ...
              <p className="text-muted">Supports .html,.htm,text/html</p>
              <input type="file" ref={fileInputRef} className="hidden" accept=".html,.htm,text/html" onChange={handleFileChange} />
            </div>
