...
export default function ImageToPdfClient() {
  ...
  return (
    <ToolLayout
      ...
      relatedTools={[
        { name: "Image Compressor", href: "/image-compressor", icon: <CheckCircle2 /> }
      ]}
    >
            ...
            {files.length > 0 && (
              <div className="glass-card">
                ...
                <div className="flex flex-col gap-2 mb-6 max-h-60 overflow-y-auto pr-2">
                  {files.map((f, i) => (
                    <div key={i} className="flex justify-between items-center p-2 rounded bg-background border border-border text-sm">
