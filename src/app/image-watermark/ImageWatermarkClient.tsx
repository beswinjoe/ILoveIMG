...
export default function ImageWatermarkClient() {
  ...
  return <>
      ...
      <div className="mb-4">
        ...
        <input type="text" value={watermarkText} onChange={e => setWatermarkText(e.target.value)} className="input w-full" placeholder="e.g. © 2026 Filoza" />
      </div>
                ...
                <div className="flex justify-center gap-4">
                  ...
                  <button className="btn btn-primary" onClick={processFile} disabled={isProcessing}>
                    {isProcessing ? <><Loader2 className="animate-spin" size={18} /> Processing...</> : <>
