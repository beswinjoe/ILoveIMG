    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-6 h-full min-h-[600px]">
        ...
        <div className="flex-1 flex flex-col glass-card p-0 overflow-hidden border border-border">
          ...
          <textarea
            className="w-full h-[500px] p-4 bg-background resize-none focus:outline-none focus:ring-0 border-none font-mono text-sm leading-relaxed"
        ...
        <div className="flex-1 flex flex-col glass-card p-0 overflow-hidden border border-border">
          ...
          {error ? (
            <div className="h-[500px] p-6 bg-danger/10 text-danger flex flex-col gap-3 font-mono text-sm border-b border-border">
            ...
            <textarea
              className="w-full h-[500px] p-4 bg-foreground/5 text-foreground resize-none focus:outline-none focus:ring-0 border-none font-mono text-sm leading-relaxed border-b border-border"
