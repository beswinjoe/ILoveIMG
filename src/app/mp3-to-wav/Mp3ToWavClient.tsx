      ...
      <div className="max-w-3xl mx-auto">
        {!audioUrl ? <>
            <div className="dropzone mb-8" onDrop={handleDrop} onDragOver={e => e.preventDefault()} onClick={() => fileInputRef.current?.click()}>
              ...
              <input type="file" ref={fileInputRef} className="hidden" accept=".mp3,audio/mpeg" onChange={handleFileChange} />
            </div>
            ...
            setAudioUrl(null);
              ...
              <a href={audioUrl} download={`${file?.name.replace(/\.[^/.]+$/, "")}.wav`} className="btn btn-primary" style={{
            textDecoration: 'none'
          }}>
