            ...
            {files.length > 0 && (
              <div className="glass-card">
                ...
                <div className="flex flex-col gap-2 mb-6 max-h-[400px] overflow-y-auto pr-2">
                  {files.map((f, i) => (
                    <div key={i} className="flex justify-between items-center p-3 rounded bg-background border border-border">
                      ...
                      <div className="flex items-center gap-2">
                        <button 
                          className="p-1 hover:bg-surface rounded text-muted disabled:opacity-30" 
                        ...
                        <button 
                          className="p-1 hover:bg-danger/10 text-danger rounded ml-2" 
