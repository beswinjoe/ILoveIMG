        ...
        {!pdfUrl ? <>
            ...
            {file && <div className="glass-card">
                ...
                <div className="mb-8 p-6 bg-background rounded-lg border border-border">
                  ...
                  <input type="text" className="input w-full" value={pagesToDelete} onChange={e => setPagesToDelete(e.target.value)} placeholder="2, 4-6" disabled={isProcessing} />
            ...
            setPagesToDelete("");
              ...
              <a href={pdfUrl} download={`cleaned_${file?.name}`} className="btn btn-primary" style={{
            textDecoration: 'none'
          }}>
