        ...
        {!pdfUrl ? (
          ...
          <div className="glass-card text-center py-12 flex flex-col items-center">
            ...
            <div className="flex gap-4">
              <button className="btn btn-secondary" onClick={() => { setFile(null); setPdfUrl(null); setPagesToExtract(""); }}>
                Process More
              </button>
              <a href={pdfUrl} download={`extracted_${file?.name}`} className="btn btn-primary" style={{ textDecoration: 'none' }}>
