...
export default function PdfRotateClient() {
  ...
  return (
    <ToolLayout
      ...
      relatedTools={[
        { name: "Delete PDF Pages", href: "/pdf-page-delete", icon: <CheckCircle2 /> }
      ]}
    >
        ...
        {!pdfUrl ? (
            ...
            {file && (
              <div className="glass-card text-center">
                ...
                <div className="flex justify-center gap-4 mb-8">
                  <button 
                    className={`btn ${rotation === -90 ? 'btn-primary' : 'btn-secondary'}`}
                  ...
                  <button 
                    className={`btn ${rotation === 180 ? 'btn-primary' : 'btn-secondary'}`}
          ...
          <div className="glass-card text-center py-12 flex flex-col items-center">
            ...
            <div className="flex gap-4">
              ...
              <a href={pdfUrl} download={`rotated_${file?.name}`} className="btn btn-primary" style={{ textDecoration: 'none' }}>
