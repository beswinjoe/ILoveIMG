      ...
      <div className="max-w-3xl mx-auto">
        {!pdfUrl ? <>
            ...
            {file && <div className="glass-card">
                ...
                <div className="mb-8 p-6 bg-background rounded-lg border border-border flex flex-col gap-6">
                  <div>
                    ...
                    <input type="text" className="input w-full max-w-md" value={watermarkText} onChange={e => setWatermarkText(e.target.value)} placeholder="CONFIDENTIAL" disabled={isProcessing} />
                  </div>
                  ...
                  <div className="max-w-md">
                    ...
                    <input type="range" min="0.05" max="1" step="0.05" value={opacity} onChange={e => setOpacity(parseFloat(e.target.value))} className="w-full mt-2" disabled={isProcessing} />
                  </div>
                </div>
            ...
            setPdfUrl(null);
              ...
              <a href={pdfUrl} download={`watermarked_${file?.name}`} className="btn btn-primary" style={{
            textDecoration: 'none'
          }}>
