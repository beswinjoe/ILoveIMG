...
export default function QrGeneratorClient() {
  ...
  React.useEffect(() => {
    if (qrType === "url") setQrValue(url || "https://");else if (qrType === "text") setQrValue(text || " ");else if (qrType === "wifi") setQrValue(`WIFI:S:${wifiSsid};T:${wifiEnc};P:${wifiPass};;`);else if (qrType === "email") setQrValue(`mailto:${emailTo}`);else if (qrType === "phone") setQrValue(`tel:${phone}`);
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 glass-card border border-border">
          ...
          <div className="mb-8 p-4 bg-background rounded border border-border">
            ...
            {qrType === "wifi" && <div className="flex flex-col gap-4">
                <div>
        ...
        <div className="md:w-1/3 flex flex-col items-center justify-center p-8 glass-card border border-border">
          <div className="bg-white p-4 rounded-xl shadow-lg mb-6" ref={qrRef}>
            <QRCodeCanvas value={qrValue || " "} size={size} fgColor={fgColor} bgColor={bgColor} level="H" includeMargin={true} />
          </div>
