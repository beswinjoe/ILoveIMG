      ...
      <div className="max-w-3xl mx-auto">
        {!outputUrl ? <>
            ...
            <div className="glass-card mb-8">
              ...
              <textarea value={text} onChange={e => setText(e.target.value)} className="input w-full min-h-[300px] mb-4 p-4 font-mono text-sm" placeholder="Type or paste your text here..."></textarea>
            ...
            setText("");
              ...
              <a href={outputUrl} download="document.pdf" className="btn btn-primary" style={{
            textDecoration: 'none'
          }}>
