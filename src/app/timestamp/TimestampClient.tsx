      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-8">
        ...
        <div className="glass-card flex flex-col items-center justify-center p-8 border border-primary/20 bg-primary/5">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => copyToClipboard(currentTimestamp.toString())} className="p-2 bg-background border border-border rounded-md hover:bg-surface transition-colors" title="Copy">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="glass-card flex flex-col h-full border border-border">
            ...
            <div className="mb-6">
              ...
              <input type="text" className="input w-full font-mono text-lg" value={unixInput} onChange={e => setUnixInput(e.target.value)} placeholder="e.g. 1672531200" />
            ...
            <div className="flex-1 space-y-4">
              <div className="bg-background p-4 rounded border border-border group relative">
                ...
                {dateOutput && <button onClick={() => copyToClipboard(dateOutput.local)} className="absolute right-4 top-1/2 -translate-y-1/2 p-2 text-muted hover:text-foreground opacity-0 group-hover:opacity-100 transition-all">
              ...
              <div className="bg-background p-4 rounded border border-border group relative">
                ...
                {dateOutput && <button onClick={() => copyToClipboard(dateOutput.utc)} className="absolute right-4 top-1/2 -translate-y-1/2 p-2 text-muted hover:text-foreground opacity-0 group-hover:opacity-100 transition-all">
              ...
              <div className="bg-background p-4 rounded border border-border group relative">
                ...
                {dateOutput && <button onClick={() => copyToClipboard(dateOutput.iso)} className="absolute right-4 top-1/2 -translate-y-1/2 p-2 text-muted hover:text-foreground opacity-0 group-hover:opacity-100 transition-all">
          ...
          <div className="glass-card flex flex-col h-full border border-border">
            ...
            <div className="mb-6">
              ...
              <input type="datetime-local" className="input w-full text-lg" value={dateInput} onChange={e => setDateInput(e.target.value)} />
            </div>
            ...
            <div className="flex-1 space-y-4">
              <div className="bg-background p-4 rounded border border-border group relative">
                ...
                {unixOutputSeconds !== null && <button onClick={() => copyToClipboard(unixOutputSeconds.toString())} className="absolute right-4 top-1/2 -translate-y-1/2 p-2 text-muted hover:text-foreground opacity-0 group-hover:opacity-100 transition-all">
              ...
              <div className="bg-background p-4 rounded border border-border group relative">
                ...
                {unixOutputMillis !== null && <button onClick={() => copyToClipboard(unixOutputMillis.toString())} className="absolute right-4 top-1/2 -translate-y-1/2 p-2 text-muted hover:text-foreground opacity-0 group-hover:opacity-100 transition-all">
