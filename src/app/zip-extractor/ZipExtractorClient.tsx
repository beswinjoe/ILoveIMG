...
export default function ZipExtractorClient() {
  ...
  return (
    <ToolLayout
      ...
      breadcrumbs={[{ label: "Archive", href: "/#archive" }, { label: "ZIP Extractor", href: "/zip-extractor" }]}
      howItWorks={[
        "Drag and drop your .zip file into the box above.",
      ...
      relatedTools={[
        ...
        { name: "RAR Extractor", href: "/rar-extractor", icon: <ArchiveRestore /> },
      ]}
    >
      {!archiveFile ? (
